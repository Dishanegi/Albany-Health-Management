        ...
        if request_type in ['Create', 'Update']:
            ...
            for trigger in response.get('Triggers', []):
                ...
                if (trigger.get('Type') == 'CONDITIONAL' and 
                    trigger.get('WorkflowName') == 'AlbanyHealthGarminHealthMetricsWorkflow' and
                    ('GarminTrigger0' in trigger_name or 'GarminTrigger1' in trigger_name)):
            ...
            print(f"Activated {activated_count} Garmin triggers")
