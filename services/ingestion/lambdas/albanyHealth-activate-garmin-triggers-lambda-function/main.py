...
def handler(event, context):
    ...
    for the Garmin Health Metrics workflow after CDK deployment.
    ...
    try:
        ...
        workflow_name = os.environ.get('WORKFLOW_NAME', 'AlbanyHealthGarminHealthMetricsWorkflow')
        env_suffix = os.environ.get('ENVIRONMENT', '')
        
        request_type = event['RequestType']
        
        if request_type in ['Create', 'Update']:
            # Get all triggers for the Garmin workflow
            ...
            for trigger in response.get('Triggers', []):
                ...
                # Check if this is one of our CONDITIONAL triggers for Garmin workflow
                ...
                matches_trigger_pattern = 'GarminTrigger' in trigger_name
            ...
            print(f"Activated {activated_count} Garmin triggers for workflow: {workflow_name}")
